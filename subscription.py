...
def verifySubscriptionInvalidOption(c):
    ...
    command = [
        'subscription -x',
        'subscription -a list -x',
        'subscription -a mod -x',
        'subscription -a enable -x ',
        'subscription -a disable -x',
        'subscription -a test -x'
    ]
...
def verifySubscriptionInvalidParameters(c):
    ...
    command = [
        'subscription test',
        'subscription -a list test',
        'subscription -a mod test',
        'subscription -a enable test ',
        'subscription -a disable test',
        'subscription -a test test'
    ]
...
def verifySubscriptionMissingParameters(c):
    ...
    command = [
        'subscription -a',
        'subscription -a mod -u',
        'subscription -a mod -s',
        'subscription -a list -v -t ',
        'subscription -a test -u'
    ]
