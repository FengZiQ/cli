...
def verifyRcache(c):
    ...
    if FailFlag:
        tolog('\n<font color="red">Fail: rcache </font>')
        tolog(Fail)
    else:
...
def verifyRcacheList(c):
    ...
    if FailFlag:
        tolog('\n<font color="red">Fail: rcache -a list </font>')
        tolog(Fail)
    else:
        tolog('\n<font color="green">Pass</font>')
        tolog(Pass)
...
def verifyRcacheAdd(c):
    ...
    if FailFlag:
        tolog('\n<font color="red">Fail: rcache add </font>')
        tolog(Fail)
    else:
        tolog('\n<font color="green">Pass</font>')
        tolog(Pass)
...
def verifyRcacheDel(c):
    FailFlag = False
    tolog("<b>Verify rcache -a del</b>")

    if FailFlag:
        tolog('\n<font color="red">Fail: rcache del </font>')
        tolog(Fail)
    else:
        tolog('\n<font color="green">Pass</font>')
        tolog(Pass)
